...
//        public static final byte CODE93  = 72;
	 ...
	 * modes to the modes that were in effect when the power was turned on. ESC @;
	 * 
	 * @return bytes for this command
	 */
	...
	/**
	 * Turn emphasized mode on ESC E n
	 * 
	 * @return bytes for this command
	 */
	...
	/**
	 * Turn emphasized mode off ESC E n
	 * 
	 * @return bytes for this command
	 */
	...
	/**
	 * double height width mode on Font A ESC ! n
	 * 
	 * @return bytes for this command
	 */
...
//    }
	...
	/**
	 * double height width mode off Font A ESC ! n
	 * 
	 * @return bytes for this command
	 */
	...
	/**
	 * Select double height mode Font A ESC ! n
	 * 
	 * @return bytes for this command
	 */
	...
	/**
	 * disable double height mode, select Font A ESC ! n
	 * 
	 * @return bytes for this command
	 */
	...
	/**
	 * Print and feed n lines Prints the data in the print buffer and feeds n lines
	 * ESC d n
	 * 
	 * @param n lines
	 * @return bytes for this command
	...
	/**
	 * Print and reverse feed n lines Prints the data in the print buffer and feeds
	 * n lines in the reserve direction ESC e n
	 * 
	 * @param n lines
	 * @return bytes for this command
	 */
	...
	/**
	 * Drawer Kick Drawer kick-out connector pin 2 ESC p m t1 t2
	 * 
	 * @return bytes for this command
	 */
	...
	/**
	 * Select printing color1 ESC r n
	 * 
	 * @return bytes for this command
	 */
	...
	/**
	 * Select printing color2 ESC r n
	 * 
	 * @return bytes for this command
	 */
	...
	/**
	 * white printing mode on Turn white/black reverse printing mode on GS B n
	 * 
	 * @return bytes for this command
	 */
	...
	/**
	 * white printing mode off Turn white/black reverse printing mode off GS B n
	 * 
	 * @return bytes for this command
	 */
	...
	/**
	 * feed paper and cut Feeds paper to ( cutting position + n x vertical motion
	...
	/**
	 * feed paper and cut partial Feeds paper to ( cutting position + n x vertical
	 * motion unit ) and executes a partial cut ( one point left uncut )
	 * 
	 * @return bytes for this command
	 */
	...
	/**
	 * select bar code height Select the height of the bar code as n dots default
	 * dots = 162
	 * 
	...
	/**
	 * select font hri Selects a font for the Human Readable Interpretation (HRI)
	 * characters when printing a barcode, using n as follows:
	 * 
	 * @param n Font 0, 48 Font A 1, 49 Font B
	 * @return bytes for this command
	 */
	...
	/**
	 * select position_hri Selects the print position of Human Readable
	 * Interpretation (HRI) characters when printing a barcode, using n as follows:
	 * 
	 * @param n Print position 0, 48 Not printed 1, 49 Above the barcode 2, 50 Below
	 *          the barcode 3, 51 Both above and below the barcode
	 * @return bytes for this command
	 */
	...
	/**
	 * Turn underline mode on, set at 1-dot width ESC - n
	 * 
	 * @return bytes for this command
	 */
	...
	/**
	 * Turn underline mode on, set at 2-dot width ESC - n
	 * 
	 * @return bytes for this command
	 */
