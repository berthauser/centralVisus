...
public class Ubicaciones {
	...
	public void initialize() throws FileNotFoundException {
		...
		// Cargo las imagenes
//        imgHeader.setImage(new Image("/images/ic_group_work_black_36dp.png"));
        imgHeader.setImage(new Image("/resources/images/ic_group_work_black_36dp.png"));
	...
	private boolean showVentana(Ubicacion ubicacion) {
		try {
//			FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/iuUbicaciones.fxml"));
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/resources/fxml/iuUbicaciones.fxml"));
