...
public class CrudDomicilios {
    ...
    @FXML
    private TableView<?> tblDomicilios;
    @FXML
    ...
    @FXML
    private JFXComboBox<?> cmbLocalidad;
    @FXML
    private Label lblCodigoPostal;
    @FXML
    private JFXRadioButton rbParticular;
    @FXML
    private ToggleGroup tgDomicilio;
    @FXML
    private JFXRadioButton rgLegal;
    @FXML
    private JFXRadioButton rbFiscal;
    @FXML
    private JFXRadioButton rbSinIdentificar;
    @FXML
    ...
    @FXML
    private JFXTextField txtManzana;
    @FXML
    private JFXTextField txtSeccion;
    @FXML
    private JFXTextField txtCasa;
    @FXML
    private JFXTextField txtBarrio;
    @FXML
    private JFXTextField txtCPA;
    @FXML
...
//		imgPersonas.setImage(new Image("/images/ic_contacts_black_36dp.png"));
		imgPersonas.setImage(new Image("/resources/images/domicilios.png"));
