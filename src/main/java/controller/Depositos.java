...
//        imgHeader.setImage(new Image("/images/ic_widgets_black_36dp.png"));
        imgHeader.setImage(new Image("/resources/images/ic_widgets_black_36dp.png"));
	...
	private boolean showVentana(Deposito deposito) {
		try {
//			String fxmlFile = "/fxml/iuDepositos.fxml";
			String fxmlFile = "/resources/fxml/iuDepositos.fxml";
