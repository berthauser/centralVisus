...
public class Unidades {
	...
	public void initialize() throws FileNotFoundException {
		...
		// Cargo las imagenes
//        imgHeader.setImage(new Image("/images/ic_build_black_36dp.png"));
        imgHeader.setImage(new Image("/resources/images/ic_build_black_36dp.png"));
	...
	private boolean showVentana(Unidad Unidad) {
		try {
//			FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/iuUnidadesMedida.fxml"));
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/resources/fxml/iuUnidadesMedida.fxml"));
