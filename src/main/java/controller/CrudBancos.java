...
public class CrudBancos {
	...
	@FXML
	private JFXComboBox<String> cmbBancos;
	@FXML
	private JFXRadioButton rbCajaAhorro;
	@FXML
	private ToggleGroup tgCuenta;
	@FXML
	private JFXRadioButton rbCuentaCorriente;
	@FXML
	private JFXTextField txtNroCuenta;
	@FXML
	private JFXTextField txtCBU;
	@FXML
	private JFXTextField txtAlias;
	@FXML
...
//		imgPersonas.setImage(new Image("/images/ic_contacts_black_36dp.png"));
		imgPersonas.setImage(new Image("/resources/images/bancos.png"));
