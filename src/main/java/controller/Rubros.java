...
public class Rubros {
	...
	public void initialize() throws FileNotFoundException {
		...
		// Cargo las imagenes
//        imgRubro.setImage(new Image("/images/ic_assignment_black_36dp.png"));
        imgRubro.setImage(new Image("/resources/images/ic_assignment_black_36dp.png"));
	...
	private boolean showVentanaRubro(Rubro rubro) {
		try {
//			FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/iuRubros.fxml"));
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/resources/fxml/iuRubros.fxml"));
