...
public class Presentaciones {
	...
	public void initialize() throws FileNotFoundException {
		...
		// Cargo las imagenes
//	    Image image0 = new Image(new FileInputStream("src/main/resources/images/presentaciones.png"));
...
//	    imgHeader.setPreserveRatio(true);
	...
	private boolean showVentana(Presentacion presentacion) {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/iuPresentaciones.fxml"));
